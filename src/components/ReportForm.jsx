...
const config: WormholeConnectConfig = {
  ...
  tokens: ["ETH", "WETH", "MATIC", "WMATIC","AVAX","WAVAX"],
  rpc: {
...
const ReportForm = () => {
  ...
  const handleWom = (event) => {
    worm?setWorm(false):setWorm(true);
    
    // Now you can use 'wormholeBridge' as needed
  ...
  return (
    ...
    <div className="container">
      <div className="left-content">
        {/* Your text and image content goes here */}
      </div>
      <div className="right-content">
      <button onClick={handleWom} className="report-form-button">
          Transfer ETH to AVAX
        </button>
        {worm && <WormholeBridge config={config} />}
